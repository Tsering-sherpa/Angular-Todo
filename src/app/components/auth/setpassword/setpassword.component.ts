...
import { MustMatch } from 'src/app/shared/validator/mustmatch';
import { hasNumber, hasSpecialCharacter, hasUpperCase } from 'src/app/shared/validator/password-validator';
